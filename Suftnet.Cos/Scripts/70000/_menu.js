        ...
        _dataTables._menu = $('#tblMenu').DataTable({
            ...
            "columns": [
                ...
                },    
                {
                    ...
                    "defaultContent": '<a style=margin:10px; href="#" onclick=_menu.edit(this)><img src=' + suftnet_grid.iconUrl + 'edit.png\ alt=\"Edit this row\" /></a>' +
                        '<a style=margin:10px; href="#" onclick="_menu.delete(this)"><img src=' + suftnet_grid.iconUrl + 'delete.png\ alt=\"Delete this row\" /></a>' +
                        '<a style=margin:10px; href="#" onclick="_menu.view(this)"><img src=' + suftnet_grid.iconUrl + 'folder.png\ alt=\"View Addon\" /></a>'
                }
            ],
            columnDefs: [
