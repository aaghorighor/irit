namespace Suftnet.Cos.BackOffice
{
    ...
    public class DiscountController : BackOfficeBaseController
    {     
        #region Resolving dependencies

        private readonly IDiscount  _common;

        public DiscountController(IDiscount common)
        {             
            _common = common;                     
        }
        ...
        public JsonResult Create(DiscountDto entityToCreate)
        {
        ...
        [HttpPost]    
        [ValidateAntiForgeryToken]
        public JsonResult Edit(DiscountDto entityToCreate)
        {
            Ensure.Argument.NotNull(entityToCreate);
