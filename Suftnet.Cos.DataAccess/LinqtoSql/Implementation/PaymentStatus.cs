   ...
   public class PaymentStatus : IPaymentStatus
    {     
        public bool Delete(Guid id)
        {
            ...
            {
                var objToDelete = context.PaymentStatuses.FirstOrDefault(o => o.Id == id);

                if (objToDelete != null)
                {
                    context.PaymentStatuses.Remove(objToDelete);
                    context.SaveChanges();
                    response = true;
                }
            }
        ...
        public Guid Insert(CommonTypeDto entity)
        {
            ...
            using (var context = DataContextFactory.CreateContext())
            {
                var obj = new Action.PaymentStatus() { Id = entity.Id,  Active = entity.Active, IndexNo = entity.IndexNo,  Name = entity.Name, CreatedBy = entity.CreatedBy, CreatedDt = entity.CreatedDT };
                context.PaymentStatuses.Add(obj);
                context.SaveChanges();
                id = obj.Id;
            }
            return id;
        ...
        public bool Update(CommonTypeDto entity)
        {
            ...
            using (var context = DataContextFactory.CreateContext())
            {
                var objToUpdate = context.PaymentStatuses.SingleOrDefault(o => o.Id == entity.Id);
        ...
        public CommonTypeDto Get(Guid id)
        {
            using (var context = DataContextFactory.CreateContext())
            {
                var result = (from o in context.PaymentStatuses
                              where o.Id == id                        
