...
var table = {
    ...
    load: function () {
        _dataTables.table = $('#tblTable').DataTable({
            ...
            "columns": [
                ...
                },                            
                {
                    ...
                    "defaultContent": '<a class="tooltip" title="Edit this row" style=margin:10px; href="#" onclick=table.edit(this)><img src=' + suftnet_grid.iconUrl + 'edit.png\ alt=\"Edit this row\" /></a>' +
                        '<a class="tooltip" title="Delete this row" style=margin:10px; href="#" onclick="table.delete(this)"><img src=' + suftnet_grid.iconUrl + 'delete.png\ alt=\"Delete this row\" /></a>'                      
                }
            ],
            columnDefs: [
        ...
        _dataTables.table.on("draw", function () {
