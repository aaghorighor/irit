...
var addonType = {
                  ...
                  function (data) {
                      ...
                      switch (data.flag) {
                          case 1: //// add    
                              ...
                              _dataTables.addonType.ajax.reload();
                              break;
                          case 2: //// update
    ...
    edit: function (obj) {
        ...
        var dataobject = _dataTables.addonType.row($(obj).parents('tr')).data();
    ...
    delete: function (obj) {
        ...
        if (dataobject != null) {
            js.dyconfirm($("#deleteUrl").attr("data-deleteUrl"), { Id: dataobject.Id }, dataobject.Id, "#tblTax").then(
                function (data) {
                    _dataTables.addonType.row($(obj).parents('tr')).remove().draw();
                });
        }
    ...
    load: function () {
        _dataTables.addonType = $('#tblAddonType').DataTable({        
            "serverSide": false,
            ...
            "columns": [
                ...
                { "data": "Active", "defaultContent": "<i>-</i>" },
                {
                    ...
                    "defaultContent": '<a style=margin:10px; href="#" onclick=addonType.edit(this)><img src=' + suftnet_grid.iconUrl + 'edit.png\ alt=\"Edit this row\" /></a>'+
                        '<a style=margin:10px; href="#" onclick="addonType.delete(this)" > <img src=' + suftnet_grid.iconUrl + 'delete.png\ alt=\"Delete this row\" /></a>'
                }
            ],
            columnDefs: [
