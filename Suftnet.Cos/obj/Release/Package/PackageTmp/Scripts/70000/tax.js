        ...
        _dataTables.tax = $('#tblTax').DataTable({        
            ...
            "columns": [
                ...
                { "data": "Active", "defaultContent": "<i>-</i>" },
                {
                    ...
                    "defaultContent": '<a style=margin:10px; href="#" onclick=tax.edit(this)><img src=' + suftnet_grid.iconUrl + 'edit.png\ alt=\"Edit this row\" /></a>'+
                        '<a style=margin:10px; href="#" onclick="tax.delete(this)" > <img src=' + suftnet_grid.iconUrl + 'delete.png\ alt=\"Delete this row\" /></a>'
                }
            ],
            columnDefs: [
