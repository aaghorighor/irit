...
namespace Suftnet.Cos.DataAccess
{
    ...
    public interface IMenu 
    {
        ...
        List<MenuDto> GetAll(Guid tenantId, Guid categoryId, int iskip, int itake, string isearch);
        List<MenuDto> GetAll(Guid tenantId, Guid categoryId, int iskip, int itake);
